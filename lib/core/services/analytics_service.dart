...
class AnalyticsService {
  ...
  Future<void> logItemViewed({required String itemId, String? category}) async {
    await _analytics.logViewItem(
      items: [AnalyticsEventItem(itemId: itemId, itemCategory: category)],
    );
  }
  ...
  Future<void> logFavoriteToggled({
    ...
    await _analytics.logEvent(
      name: 'favorite_${added ? 'add' : 'remove'}',
      parameters: {'item_id': itemId},
    );
  }

  Future<void> logTradeOfferSent({
    required String tradeId,
    required String itemId,
  }) async {
    await _analytics.logEvent(
      name: 'trade_offer_sent',
      parameters: {'trade_id': tradeId, 'item_id': itemId},
    );
  }
  ...
  Future<void> logUserRated({
    required String ratedUserId,
    required int rating,
  }) async {
    await _analytics.logEvent(
      name: 'user_rated',
      parameters: {'rated_user_id': ratedUserId, 'rating': rating},
    );
  }
  ...
  Future<void> logProfileViewed({required String profileUserId}) async {
    await _analytics.logEvent(
      name: 'profile_viewed',
      parameters: {'profile_user_id': profileUserId},
    );
  }
  ...
  Future<void> logItemClicked({
    ...
    await _analytics.logSelectContent(contentType: 'item', itemId: itemId);
    await _analytics.logEvent(
      name: 'item_clicked',
      parameters: {
        'item_id': itemId,
  ...
  Future<void> logSimilarItemsViewed({
    ...
    await _analytics.logEvent(
      name: 'similar_items_viewed',
      parameters: {'source_item_id': sourceItemId, 'count': count},
    );
  }
  ...
  Future<void> logItemImageFullscreen({
    ...
    await _analytics.logEvent(
      name: 'item_image_fullscreen',
      parameters: {'item_id': itemId, 'image_index': imageIndex},
    );
  }
  ...
  Future<void> logSellerContactClicked({
    ...
    await _analytics.logEvent(
      name: 'seller_contact_clicked',
      parameters: {'item_id': itemId, 'seller_id': sellerId},
    );
  }
  ...
  Future<void> logListingCategorySelected({required String category}) async {
    await _analytics.logEvent(
      name: 'listing_category_selected',
      parameters: {'category': category},
    );
  }
  ...
  Future<void> logListingLocationAdded({
    ...
    await _analytics.logEvent(
      name: 'listing_location_added',
      parameters: {'city': city, if (usedMap != null) 'used_map': usedMap},
    );
  }
  ...
  Future<void> logListingAbandoned({
    ...
    await _analytics.logEvent(
      ...
      parameters: {'abandoned_at': abandonedAt},
    );
  }
  ...
  Future<void> logUserVerified({required String verificationType}) async {
    await _analytics.logEvent(
      name: 'user_verified',
      parameters: {'verification_type': verificationType},
    );
  }
  ...
  Future<void> logMapInteraction({
    ...
    await _analytics.logEvent(
      ...
      parameters: {'action': action, if (itemId != null) 'item_id': itemId},
    );
  }
  ...
  Future<void> logTrustBadgeViewed({
    ...
    await _analytics.logEvent(
      name: 'trust_badge_viewed',
      parameters: {'badge_type': badgeType, 'user_id': userId},
    );
  }
  ...
  Future<void> logSlowOperation({
    ...
    await _analytics.logEvent(
      name: 'slow_operation',
      parameters: {'operation': operation, 'duration_ms': durationMs},
    );
  }
  ...
  Future<void> logBarterMatchQualityPreference({
    ...
    await _analytics.logEvent(
      name: 'barter_match_quality_preference',
      parameters: {
        'source_item_id': sourceItemId,
        'quality': quality,
        'match_count': matchCount,
  ...
  Future<void> logBarterDistancePreference({
    ...
    await _analytics.logEvent(
      name: 'barter_distance_preference',
      parameters: {
        'source_item_id': sourceItemId,
