...
class WorldClassDesignSystem {
  ...
  static TextStyle get headingXLarge => displaySmall.copyWith(color: primaryText);
  static TextStyle get headingXXLarge => displayMedium.copyWith(color: primaryText);
