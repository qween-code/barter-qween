...
class SendTradeOfferPage extends StatefulWidget {
  ...
  const SendTradeOfferPage({super.key, required this.requestedItem});
...
class _SendTradeOfferPageState extends State<SendTradeOfferPage> {
  ...
  void _sendOffer() {
    ...
    final rawDisplayName = authState.user.displayName;
    final resolvedFromName =
    ...
    final offer = TradeOfferEntity(
      ...
      fromUserName: resolvedFromName,
      toUserName: widget.requestedItem.ownerName.isNotEmpty
          ? widget.requestedItem.ownerName
          : 'Satıcı',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Send Trade Offer'), elevation: 0),
